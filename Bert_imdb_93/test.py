...
cleaned_reviews = origin_train_df['data'].apply(preprocess_text)
cleaned_reviews_test = test_df['data'].apply(preprocess_text)

label_encoder = preprocessing.LabelEncoder()
target = label_encoder.fit_transform(origin_train_df['label'])
target_test = label_encoder.fit_transform(test_df['label'])

X_train = cleaned_reviews
Y_train = target
X_test = cleaned_reviews_test
Y_test = target_test
...
train_InputExamples = origin_train_df.apply(lambda x: bert.run_classifier.InputExample(guid=None, # Globally unique ID for bookkeeping, unused in this example
